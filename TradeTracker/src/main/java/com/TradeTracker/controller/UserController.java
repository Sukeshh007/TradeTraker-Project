...
import com.TradeTracker.dto.LoginRequest;
import com.TradeTracker.dto.LoginResponse;
...
public class UserController {
	...
	public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest loginRequest) {
	    User user = uservice.findByEmail(loginRequest.getEmail());

	    if (user != null && loginRequest.getPassword().equals(user.getPasswordHash())) {
	        LoginResponse response = new LoginResponse();
	        response.setMessage("Login successful");
	        // Optionally, generate and set JWT token
